...
// Keep hgctl on the Kubernetes versions supported by the Istio 1.27 fork.
// Dependency-module replace directives are not inherited, so mirror the
// compatibility replacements from istio/istio/go.mod here.
