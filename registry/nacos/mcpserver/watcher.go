...
func (w *watcher) getServiceCallback(server *provider.McpServer, configGroup, dataId, path string) func(services []model.Instance, err error) {
	...
	if namespace == "" {
		namespace = provider.DefaultNacosServiceNamespace
	}
