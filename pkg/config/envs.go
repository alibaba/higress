...
var (
	...
	AiEndpointPickerWasmImageUrl = env.RegisterStringVar(
		"AI_ENDPOINT_PICKER_WASM_IMAGE_URL",
		"oci://higress-registry.cn-hangzhou.cr.aliyuncs.com/plugins/ai-endpoint-picker:1.0.0-alpha",
		"Wasm URL for the built-in GIE endpoint picker; may be file:// in test environments.",
	).Get()
)
