...
docker-build: docker.higress
 ## Build and push docker images to registry defined by $HUB and $TAG
docker-build-base:
	docker buildx build --no-cache --platform linux/amd64,linux/arm64 -t ${HUB}/base:${BASE_VERSION} -f docker/Dockerfile.base .
