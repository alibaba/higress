...
// DeepCopyInto supports using WasmPluginMatchRule within kubernetes types, where deepcopy-gen is used.
func (in *WasmPluginMatchRule) DeepCopyInto(out *WasmPluginMatchRule) {
	p := proto.Clone(in).(*WasmPluginMatchRule)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WasmPluginMatchRule. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new WasmPluginMatchRule. Required by controller-gen.
func (in *WasmPluginMatchRule) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
