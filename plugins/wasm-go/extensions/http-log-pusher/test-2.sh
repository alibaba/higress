...
kubectl logs -n "$NAMESPACE" "$POD" -c higress-core --tail=100 -f --timestamps | grep --color -E "^|$|ERROR|WARN|404|500|http-log-pusher|error|collector_service|using|predefined"
