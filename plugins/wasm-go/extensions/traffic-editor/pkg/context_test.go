...
func TestEditorContext_RequestQueries(t *testing.T) {
	...
	if !ctx.IsRequestQueriesDirty() {
		t.Errorf("RequestQueriesDirty not set correctly")
	}
...
func TestEditorContext_ResetDirtyFlags(t *testing.T) {
	...
	ctx.ResetDirtyFlags()
	if ctx.IsRequestHeadersDirty() || ctx.IsRequestQueriesDirty() || ctx.IsResponseHeadersDirty() {
		t.Errorf("ResetDirtyFlags failed")
	}
}

func TestEditorContext_IsRequestHeadersDirty(t *testing.T) {
	ctx := NewEditorContext().(*editorContext)
	if ctx.IsRequestHeadersDirty() {
...
func TestEditorContext_IsRequestQueriesDirty(t *testing.T) {
	ctx := NewEditorContext().(*editorContext)
	if ctx.IsRequestQueriesDirty() {
