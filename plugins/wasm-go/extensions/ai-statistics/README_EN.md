...
| `max_request_body_bytes` | int | optional  | 104857600 (100 MiB)   | Maximum number of bytes to buffer for the request body. Supports route-level overrides via matchRules, preventing large non-AI uploads (e.g. multipart/form-data) from being rejected by Envoy with HTTP 413 |
