...
| `claudeCustomUrl` | string | 可选     | -      | Claude(Anthropic) 协议的自定义后端 URL，用于配置自定义域名/路径前缀，例如：`https://api.anthropic.com`、`https://example.com/anthropic`、`https://example.com/anthropic/v1/messages`（仅覆盖 messages 接口） |
