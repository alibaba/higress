...
const (
	...
	ApiNameFineTuningCheckpointPermission  ApiName = "openai/v1/deletefine-tuningjobcheckpointpermission"
	...
	PathOpenAIFineTuningJobs                       = "/v1/fine-tuning/jobs"
	PathOpenAIFineTuningRetrieveJob                = "/v1/fine-tuning/jobs/{fine_tuning_job_id}"
	PathOpenAIFineTuningJobEvents                  = "/v1/fine-tuning/jobs/{fine_tuning_job_id}/events"
	PathOpenAIFineTuningJobCheckpoints             = "/v1/fine-tuning/jobs/{fine_tuning_job_id}/checkpoints"
	PathOpenAIFineTuningCancelJob                  = "/v1/fine-tuning/jobs/{fine_tuning_job_id}/cancel"
	PathOpenAIFineTuningResumeJob                  = "/v1/fine-tuning/jobs/{fine_tuning_job_id}/resume"
	PathOpenAIFineTuningPauseJob                   = "/v1/fine-tuning/jobs/{fine_tuning_job_id}/pause"
	PathOpenAIFineTuningCheckpointPermissions      = "/v1/fine-tuning/checkpoints/{fine_tuned_model_checkpoint}/permissions"
	PathOpenAIFineDeleteTuningCheckpointPermission = "/v1/fine-tuning/checkpoints/{fine_tuned_model_checkpoint}/permissions/{permission_id}"
