...
// Gateway API v1.6 is built against Kubernetes 1.36, but Higress' Istio 1.27
// fork still targets Kubernetes 1.34. Keep the established Kubernetes module
// set while consuming the v1.6 API module.
